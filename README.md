...
| Run ID / YAML Name                               | Key Changed Parameter(s) vs. Champion                                     | Champion Config's Key Values (From `[YourChampionYAMLName.yaml]`)    | Peak Mean Reward | Brief Observation / Result                                               |
| :----------------------------------------------- | :------------------------------------------------------------------------ | :------------------------------------------------------------------- | :--------------- | :----------------------------------------------------------------------- |
| `Exp_With_Curiosity`| **(Champ)** | LR: 0.0003, Beta: 0.01, HU: 512, Curiosity: 0.02, TargetRwd (Script): +1.2 | **Excellent performance, solves task efficiently & robustly.** |
| `Exp_No_Curiosity`                | LR: 0.001, Beta: 0.005, HU: 128, Curiosity: N/A,  TargetRwd (Script): +1.2 | (Compared to champion)                                               | ~            | Very stable, but plateaued at negative reward before target reward increase. |
| `Exp_End_Episode_Obstacle`        | LR: 0.0001, Beta: 0.02, HU: 128,  Curiosity: 0.05, TargetRwd (Script): +1.0, End Episode active| (Compared to champion)                                               | `[~ -1.2]`       | Stable, but lower performance than champion.                             |
| `Exp_No_Curiosity`                | LR: 0.0008, Beta: 0.01, HU: 256,  Curiosity: N/A, TargetRwd (Script): +1.0   | ` Unstable or did not converge well`                            |
